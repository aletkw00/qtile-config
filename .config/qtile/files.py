...
config_home: str = str(Path.joinpath(Path(home), ".config"))
qtile_home: str = str(Path.joinpath(Path(config_home), "qtile"))
theme_home: str = str(Path.joinpath(Path(home), "themes"))
picom: str = str(Path.joinpath(Path(config_home), "picom"))
rofi_home: str = str(Path.joinpath(Path(config_home), "rofi"))
